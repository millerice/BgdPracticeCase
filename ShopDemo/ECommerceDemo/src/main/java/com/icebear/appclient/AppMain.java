...
package com.icebear.appclient;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.icebear.bean.*;
...
public class AppMain {
  ...
  public static void main(String[] args) {
    ...
    Long delay = args.length > 3 ? Long.parseLong(args[0]) : 0L;

    // 参数二：循环遍历次数
    int loop_len = args.length > 1 ? Integer.parseInt(args[1]) : 200;
